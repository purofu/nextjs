...
export function C01NavBarTabletNotSignedIn(props){
  return (
      <>
  {(property1 == "Default") && <>
    <div className="c01NavBarTabletNotSignedIn w-[768px] h-[1024px] absolute overflow-hidden bg-white opacity-100 p-0 left-[896px] top-7">
      <div className="accordians gap-0 absolute flex-col items-start opacity-100 p-0 left-0 top-[88px] flex">
        <div className="dropdown gap-0.5 flex-col w-[768px] items-start overflow-hidden opacity-100 pt-4 pb-3 px-8 flex">
        ...
        <div className="links gap-0.5 flex-col w-[768px] items-start overflow-hidden opacity-100 pt-4 pb-3 px-8 flex">
      ...
      <div className="getInTouch w-[768px] h-[72px] absolute bg-[#34495e] opacity-100 p-0 left-0 top-[952px]">
        <div className="getInTouch gap-4 absolute flex-row w-[164px] items-center opacity-100 p-0 left-8 top-[23px] flex">
        ...
        <div className="squareCTA w-[77px] h-[72px] absolute gap-[10.18104076385498px] bg-[#273e54] opacity-100 p-0 left-[691px] top-0">
      ...
      <div className="frame482695 gap-0 absolute flex-col w-[343px] items-end opacity-100 p-0 left-8 top-[828px] flex">
      ...
      <div className="frame482696 gap-0 absolute flex-col w-[343px] items-end opacity-100 p-0 left-8 top-[884px] flex">
        <div className="signIn gap-4 flex-row w-[342px] items-end opacity-100 pl-0 pr-[21px] py-4 flex">
  ...
  {(property1 == "Default") && <>
    <div className="c01NavBarTabletNotSignedIn w-[768px] h-16 absolute overflow-hidden bg-[#0d2741] opacity-100 p-0 left-[27px] top-7">
      <span className="title font-['Volta_Modern_Display'] text-sm font-bold text-white text-left w-[110px] absolute -translate-y-2/4 left-[175px] top-2/4">RLT Care</span>
      <svg width={1} height={64} viewBox="0 0 1 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        <line x1="0.5" y1="2.18558e-08" x2="0.499997" y2={64} stroke="#34495E" />
      </svg>
      <div className="frame482676 gap-1 absolute flex-row items-start opacity-100 p-2 left-[631px] top-2 flex">
        <div className="search w-8 h-8 relative p-0">
          <div className="boundingBox w-8 h-8 relative bg-[#d9d9d9] opacity-100 p-0" />
          <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
