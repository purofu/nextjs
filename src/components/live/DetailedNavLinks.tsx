...
export function DetailedNavLinks(props){
	const {
    size = "XL"
  } = props;
  return (
      <>
  {(size == "XL") && <>
    <div className="detailedNavLinks gap-0 absolute flex-col w-[204px] items-start opacity-100 px-0 py-[11px] border-y-[#bdbdbd] border-t border-b left-2 top-2 flex">
  ...
  {(size == "S") && <>
    <div className="detailedNavLinks gap-0 absolute flex-col w-[342px] items-start opacity-100 px-0 py-[15px] border-y-[#bdbdbd] border-t border-b left-2 top-[134px] flex">
