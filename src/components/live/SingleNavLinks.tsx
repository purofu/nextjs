...
export function SingleNavLinks(props){
	const {
    size = "XL"
  } = props;
  return (
      <>
  {(size == "XL") && <>
    <div className="singleNavLinks gap-3 absolute flex-col items-start opacity-100 p-0 left-2 top-2 flex">
  ...
  {(size == "S") && <>
    <div className="singleNavLinks gap-3 absolute flex-col w-[342px] items-start opacity-100 p-0 left-2 top-[86px] flex">
