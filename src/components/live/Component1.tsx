...
export function Component1(props){
  ...
  {(action == "sign in" && active == "doccheck") && <>
    <div className="component1 gap-[19px] absolute flex-col h-[620px] justify-between items-start w-[179px] bg-[#eeeeee] opacity-100 pl-2 pr-0 py-8 left-5 top-[22px] flex">
  ...
  <variant match="action\=register, active\=doccheck">
    <div className="component1 gap-[19px] absolute flex-col h-[620px] justify-between items-start w-[179px] bg-[#eeeeee] opacity-100 pl-2 pr-0 py-8 left-[677px] top-[22px] flex">
      <div className="frame42 gap-10 flex-col items-start w-full opacity-100 p-0 flex">
        <div className="frame39 gap-2.5 flex-col items-start w-full opacity-100 pl-2 pr-0 py-0 flex">
          <div className="frame22 gap-0 flex-col justify-center items-center opacity-100 p-0 flex">
  ...
  {(action == "sign in" && active == "novartis") && <>
    <div className="component1 gap-[19px] absolute flex-col h-[620px] justify-between items-start w-[179px] bg-[#eeeeee] opacity-100 pl-2 pr-0 py-8 left-[239px] top-[21px] flex">
      <div className="frame42 gap-10 flex-col items-start w-full opacity-100 p-0 flex">
        <div className="frame39 gap-2.5 flex-col items-start w-full opacity-100 pl-2 pr-0 py-0 flex">
          <div className="frame22 gap-0 flex-col justify-center items-center opacity-100 p-0 flex">
            <span className="signInMethod font-['Inter'] text-base font-semibold text-black text-center">Sign in method</span>
  ...
  <variant match="action\=register, active\=novartis">
    <div className="component1 gap-[19px] absolute flex-col h-[620px] justify-between items-start w-[179px] bg-[#eeeeee] opacity-100 pl-2 pr-0 py-8 left-[896px] top-[21px] flex">
      <div className="frame42 gap-10 flex-col items-start w-full opacity-100 p-0 flex">
        <div className="frame39 gap-2.5 flex-col items-start w-full opacity-100 pl-2 pr-0 py-0 flex">
          <div className="frame22 gap-0 flex-col justify-center items-center opacity-100 p-0 flex">
            <span className="registration font-['Inter'] text-base font-semibold text-black text-center">Registration</span>
  ...
  {(action == "sign in" && active == "pin") && <>
    <div className="component1 gap-[19px] absolute flex-col h-[620px] justify-between items-start w-[179px] bg-[#eeeeee] opacity-100 pl-2 pr-0 py-8 left-[458px] top-5 flex">
      <div className="frame42 gap-10 flex-col items-start w-full opacity-100 p-0 flex">
        <div className="frame39 gap-2.5 flex-col items-start w-full opacity-100 pl-2 pr-0 py-0 flex">
          <div className="frame22 gap-0 flex-col justify-center items-center opacity-100 p-0 flex">
            <span className="signInMethod font-['Inter'] text-base font-semibold text-black text-center">Sign in method</span>
