...
export function C45LongformTags(props){
	const {
    size = "L",
    iconButtons = "Yes"
  } = props;
  return (
      <>
  {(size == "L" && iconButtons == "Yes") && <>
    <div className="c45LongformTags gap-12 absolute flex-col w-[1440px] items-start bg-white opacity-100 pl-[504px] pr-[162px] pt-6 pb-12 left-[35px] top-4 flex">
      <div className="imageBreadcrumb gap-2 flex-col w-[1036px] items-start opacity-100 p-0 !hidden flex">
        <div className="image gap-4 flex-col w-[1036px] items-start opacity-100 p-0 flex">
          <img src="/images/rectangle4200.png" onerror="this.src='http://svgur.com/i/x4x.svg'" className="rectangle4200 w-[1036px] h-[247px] relative opacity-100 object-cover p-0" />
        </div>
      </div>
      <div className="frame482778 gap-4 flex-row items-start opacity-100 p-0 flex">
        <div className="download gap-0 flex-row items-start opacity-100 p-0 flex">
          <div className="download gap-[-0.8079625368118286px] flex-row items-start border bg-white opacity-100 p-0 border-[#1a324b] flex">
            <div className="download gap-[3.2318501472473145px] flex-row h-10 justify-center items-center opacity-100 px-[18px] py-[12.927400588989258px] flex">
              <span className="drugDiscovery font-['Volta_Modern_Display'] text-base font-semibold text-[#1a324b] text-center tracking-[0px]">Drug Discovery</span>
            </div>
          </div>
        </div>
        <div className="download gap-0 flex-row items-start opacity-100 p-0 flex">
          <div className="download gap-[-0.8079625368118286px] flex-row items-start border bg-white opacity-100 p-0 border-[#1a324b] flex">
            <div className="download gap-[3.2318501472473145px] flex-row h-10 justify-center items-center opacity-100 px-[18px] py-[12.927400588989258px] flex">
              <span className="scientificResearch font-['Volta_Modern_Display'] text-base font-semibold text-[#1a324b] text-center tracking-[0px]">Scientific Research</span>
            </div>
          </div>
        </div>
        <div className="download gap-0 flex-row items-start opacity-100 p-0 flex">
          <div className="download gap-[-0.8079625368118286px] flex-row items-start border bg-white opacity-100 p-0 border-[#1a324b] flex">
            <div className="download gap-[3.2318501472473145px] flex-row h-10 justify-center items-center opacity-100 px-[18px] py-[12.927400588989258px] flex">
              <span className="drugDevelopment font-['Volta_Modern_Display'] text-base font-semibold text-[#1a324b] text-center tracking-[0px]">Drug Development</span>
            </div>
          </div>
        </div>
        <div className="download gap-0 flex-row items-start opacity-100 p-0 flex">
          <div className="download gap-[-0.8079625368118286px] flex-row items-start border bg-white opacity-100 p-0 border-[#1a324b] flex">
            <div className="download gap-[3.2318501472473145px] flex-row h-10 justify-center items-center opacity-100 px-[18px] py-[12.927400588989258px] flex">
              <span className="musculoskeletalDiseases font-['Volta_Modern_Display'] text-base font-semibold text-[#1a324b] text-center tracking-[0px]">Musculoskeletal Diseases</span>
            </div>
          </div>
        </div>
      </div>
      <div className="frame482813 gap-0 flex-col items-start w-full opacity-100 p-0 flex">
        <div className="1pxDivider w-full h-px relative overflow-hidden bg-[#212121] opacity-100 p-0" />
        <div className="frame483135 gap-2 flex-row items-start opacity-100 p-0 flex">
          <div className="downlaod gap-1 flex-row w-[42px] h-[42px] justify-center items-center opacity-100 p-0 flex">
  ...
  {(size == "Size6" && iconButtons == "No") && <>
    <div className="c45LongformTags gap-12 absolute flex-col w-[1440px] items-start bg-white opacity-100 pl-[504px] pr-[162px] pt-6 pb-12 left-[35px] top-[604px] flex">
      <div className="imageBreadcrumb gap-2 flex-col w-[1036px] items-start opacity-100 p-0 !hidden flex">
        <div className="image gap-4 flex-col w-[1036px] items-start opacity-100 p-0 flex">
          <img src="/images/rectangle4200.png" onerror="this.src='http://svgur.com/i/x4x.svg'" className="rectangle4200 w-[1036px] h-[247px] relative opacity-100 object-cover p-0" />
        </div>
  ...
  {(size == "S" && iconButtons == "Yes") && <>
    <div className="c45LongformTags gap-1 absolute flex-row w-[375px] items-start overflow-hidden bg-white opacity-100 px-4 py-10 left-[2494px] top-4 flex">
      <div className="frame482767 gap-4 flex-col items-start flex-1 min-w-0 opacity-100 p-0 flex">
        <div className="frame482778 gap-4 flex-col items-start w-full opacity-100 p-0 flex">
          <div className="frame482857 gap-4 flex-col items-start opacity-100 p-0 flex">
            <div className="download gap-0 flex-row items-start opacity-100 p-0 flex">
              <div className="download gap-[-0.8079625368118286px] flex-row items-start border bg-white opacity-100 p-0 border-[#1a324b] flex">
                <div className="download gap-[3.2318501472473145px] flex-row h-10 justify-center items-center opacity-100 px-[18px] py-3 flex">
                  <span className="drugDiscovery font-['Volta_Modern_Display'] text-base font-semibold text-[#1a324b] text-center tracking-[0px]">Drug Discovery</span>
                </div>
              </div>
            </div>
          ...
          <div className="frame482856 gap-4 flex-col items-start w-full opacity-100 p-0 flex">
            <div className="download gap-0 flex-row items-start opacity-100 p-0 flex">
              <div className="download gap-[-0.8079625368118286px] flex-row items-start border bg-white opacity-100 p-0 border-[#1a324b] flex">
                <div className="download gap-[3.2318501472473145px] flex-row h-10 justify-center items-center opacity-100 px-[18px] py-3 flex">
                  <span className="drugDevelopment font-['Volta_Modern_Display'] text-base font-semibold text-[#1a324b] text-center tracking-[0px]">Drug Development</span>
          ...
          <div className="frame482858 gap-0 flex-col items-start w-full opacity-100 p-0 flex">
            <div className="1pxDivider w-full h-px relative overflow-hidden bg-[#212121] opacity-100 p-0" />
            <div className="frame483135 gap-2 flex-row items-start opacity-100 p-0 flex">
              <div className="downlaod gap-1 flex-row w-[42px] h-[42px] justify-center items-center opacity-100 p-0 flex">
                <div className="interactiveIcons w-[26px] h-[26px] relative opacity-100 p-0">
  ...
  {(size == "Size5" && iconButtons == "No") && <>
    <div className="c45LongformTags gap-1 absolute flex-row w-[375px] items-start overflow-hidden bg-white opacity-100 px-4 py-10 left-[2494px] top-[604px] flex">
      <div className="frame482767 gap-4 flex-col items-start flex-1 min-w-0 opacity-100 p-0 flex">
        <div className="frame482778 gap-4 flex-col items-start w-full opacity-100 p-0 flex">
          <div className="frame482857 gap-4 flex-col items-start opacity-100 p-0 flex">
            <div className="download gap-0 flex-row items-start opacity-100 p-0 flex">
  ...
  {(size == "M" && iconButtons == "Yes") && <>
    <div className="c45LongformTags gap-1 absolute flex-row w-[768px] items-start overflow-hidden bg-white opacity-100 px-8 py-10 left-[1603px] top-4 flex">
      <div className="frame482767 gap-4 flex-col w-[704px] items-start opacity-100 p-0 flex">
        <div className="frame482778 gap-4 flex-col w-[704px] items-start opacity-100 p-0 flex">
          <div className="frame482857 gap-4 flex-row items-start opacity-100 p-0 flex">
            <div className="download gap-0 flex-row items-start opacity-100 p-0 flex">
              <div className="download gap-[-0.8079625368118286px] flex-row items-start border bg-white opacity-100 p-0 border-[#1a324b] flex">
                <div className="download gap-[3.2318501472473145px] flex-row h-10 justify-center items-center opacity-100 px-[18px] py-[12.927400588989258px] flex">
                  <span className="drugDiscovery font-['Volta_Modern_Display'] text-base font-semibold text-[#1a324b] text-center tracking-[0px]">Drug Discovery</span>
          ...
          <div className="frame482856 gap-4 flex-row items-start opacity-100 p-0 flex">
            <div className="download gap-0 flex-row items-start opacity-100 p-0 flex">
              <div className="download gap-[-0.8079625368118286px] flex-row items-start border bg-white opacity-100 p-0 border-[#1a324b] flex">
                <div className="download gap-[3.2318501472473145px] flex-row h-10 justify-center items-center opacity-100 px-[18px] py-[12.927400588989258px] flex">
                  <span className="drugDevelopment font-['Volta_Modern_Display'] text-base font-semibold text-[#1a324b] text-center tracking-[0px]">Drug Development</span>
  ...
  {(size == "Size4" && iconButtons == "No") && <>
    <div className="c45LongformTags gap-1 absolute flex-row w-[768px] items-start overflow-hidden bg-white opacity-100 px-8 py-10 left-[1603px] top-[604px] flex">
      <div className="frame482767 gap-4 flex-col w-[704px] items-start opacity-100 p-0 flex">
        <div className="frame482778 gap-4 flex-col w-[704px] items-start opacity-100 p-0 flex">
          <div className="frame482857 gap-4 flex-row items-start opacity-100 p-0 flex">
            <div className="download gap-0 flex-row items-start opacity-100 p-0 flex">
        ...
        <div className="frame482814 gap-0 flex-col items-start w-full opacity-100 p-0 flex">
          <div className="1pxDivider w-full h-px relative overflow-hidden bg-[#212121] opacity-100 p-0" />
        </div>
      </div>
    </div>
