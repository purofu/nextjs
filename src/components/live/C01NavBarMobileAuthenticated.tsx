...
export function C01NavBarMobileAuthenticated(props){
	const {
    type = "Default",
    pageType = "Default",
    state = "Default",
  ...
  return (
      <>
  {(type == "Default" && pageType == "Landing" && state == "Default" && verified == "Yes" && loggedInSSO == "No") && <>
    <div className="c01NavBarMobileAuthenticated w-[375px] h-16 absolute overflow-hidden bg-[#c43b19] opacity-100 p-0 left-[49px] top-[127px]">
      ...
      <svg width={1} height={64} viewBox="0 0 1 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        <line x1="0.5" y1="2.18558e-08" x2="0.499997" y2={64} stroke="#7E1E08" />
      </svg>
  ...
  {(type == "Default" && pageType == "Default" && state == "Default" && verified == "Yes" && loggedInSSO == "No") && <>
    <div className="c01NavBarMobileAuthenticated w-[375px] h-16 absolute overflow-hidden bg-white opacity-100 p-0 left-[49px] top-[39px]">
      <div className="1pxDivider w-[375px] h-px absolute overflow-hidden bg-[#212121] opacity-100 p-0 left-0 bottom-0" />
  ...
  {(type == "HCO" && pageType == "Default" && state == "Dropdown" && verified == "Yes" && loggedInSSO == "No") && <>
    <div className="c01NavBarMobileAuthenticated w-[375px] h-[667px] absolute overflow-hidden bg-white opacity-100 p-0 left-[79px] top-[1467px]">
      ...
      <div className="frame482695 gap-0 absolute flex-col w-[343px] items-end opacity-100 p-0 left-4 top-[472px] flex">
        <div className="signIn gap-4 flex-row w-[342px] justify-between items-center opacity-100 pl-0 pr-[21px] py-4 flex">
          <div className="content gap-4 flex-row w-[200.5px] items-center opacity-100 p-0 flex">
            ...
            <div className="dropdown gap-0 flex-row items-center opacity-100 p-0 flex">
              <span className="connectYourRLTCareAccount font-['Volta_Modern_Display'] text-base font-semibold text-[#212121] text-left tracking-[0px]">Connect your RLT Care Account</span>
            </div>
          </div>
          <div className="interactiveIcons w-6 h-6 relative opacity-100 p-0">
            <div className="boundingBox absolute w-6 h-6 bg-[#d9d9d9] opacity-100 p-0 inset-[0%]" />
      ...
      <div className="frame482696 gap-0 absolute flex-col w-[343px] items-end opacity-100 p-0 left-4 top-[529px] flex">
        <div className="signIn gap-4 flex-row w-[342px] items-end opacity-100 pl-0 pr-[21px] py-4 flex">
          <div className="frame482694 gap-4 flex-row w-[200.5px] items-end opacity-100 p-0 flex">
            ...
            <div className="dropdown gap-0 flex-row items-center opacity-100 p-0 flex">
              <span className="signout font-['Volta_Modern_Display'] text-base font-semibold text-[#212121] text-left tracking-[0px]">Signout</span>
            </div>
          </div>
        </div>
      </div>
  ...
  {(type == "HCP" && pageType == "Default" && state == "Dropdown" && verified == "Yes" && loggedInSSO == "No") && <>
    <div className="c01NavBarMobileAuthenticated w-[375px] h-[667px] absolute overflow-hidden bg-white opacity-100 p-0 left-[79px] top-[776px]">
      <div className="accordians gap-0 absolute flex-col items-start opacity-100 p-0 left-0 top-[88px] flex">
  ...
  {(type == "HCP" && pageType == "Default" && state == "Dropdown" && verified == "No" && loggedInSSO == "Yes") && <>
    <div className="c01NavBarMobileAuthenticated w-[375px] h-[667px] absolute overflow-hidden bg-white opacity-100 p-0 left-20 top-[2218px]">
      <div className="accordians gap-0 absolute flex-col items-start opacity-100 p-0 left-0 top-[88px] flex">
        <div className="dropdown gap-0.5 flex-col w-[375px] items-start overflow-hidden opacity-100 pt-4 pb-3 px-4 flex">
          <div className="dropdown gap-0 flex-row justify-between items-center w-full opacity-100 p-0 flex">
            <span className="diseaseAreas font-['Volta_Modern_Display'] text-base font-medium text-[#212121] text-left tracking-[0px]">Disease areas</span>
            <div className="navDropdown gap-[4.286805152893066px] items-center opacity-100 pt-[3.2151038646698px] pb-0 px-0 flex">
              <svg className="boundingBox" width={9} height={16} viewBox="0 0 9 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_5_51756)">
                  <path d="M-0.111283 14.4307L7.39062 8.00052L-0.111283 1.57031" stroke="#212121" strokeWidth="1.39321" />
                </g>
                <defs>
                  <clipPath id="clip0_5_51756">
                    <rect width="15.0038" height="8.57361" fill="white" transform="translate(0.429688 15.502) rotate(-90)" />
                  </clipPath>
                </defs>
              </svg>
        ...
        <div className="dropdown gap-0.5 flex-col w-[375px] items-start overflow-hidden opacity-100 pt-4 pb-3 px-4 flex">
          <div className="dropdown gap-0 flex-row justify-between items-center w-full opacity-100 p-0 flex">
            ...
            <div className="navDropdown gap-[4.285714149475098px] items-center opacity-100 pt-[3.2142856121063232px] pb-0 px-0 flex">
              <svg className="boundingBox" width={9} height={16} viewBox="0 0 9 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_5_51758)">
                  <path d="M-0.109374 14.4294L7.39062 8.00084L-0.109373 1.57227" stroke="#212121" strokeWidth="1.39286" />
                </g>
                <defs>
                  <clipPath id="clip0_5_51758">
                    <rect width={15} height="8.57143" fill="white" transform="translate(0.421875 15.5) rotate(-90)" />
                  </clipPath>
                </defs>
              </svg>
        ...
        <div className="dropdown gap-0.5 flex-col w-[375px] items-start overflow-hidden opacity-100 pt-4 pb-3 px-4 flex">
          <div className="dropdown gap-0 flex-row justify-between items-center w-full opacity-100 p-0 flex">
            ...
            <div className="navDropdown gap-[4.286323070526123px] items-center opacity-100 pt-[3.2147421836853027px] pb-0 px-0 flex">
              <svg className="boundingBox" width={9} height={16} viewBox="0 0 9 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_5_51760)">
                  <path d="M-0.11044 14.4312L7.39062 8.00175L-0.110439 1.57227" stroke="#212121" strokeWidth="1.39305" />
                </g>
                <defs>
                  <clipPath id="clip0_5_51760">
                    <rect width="15.0021" height="8.57265" fill="white" transform="translate(0.421875 15.502) rotate(-90)" />
                  </clipPath>
                </defs>
              </svg>
      ...
      <div className="frame482695 gap-0 absolute flex-col w-[343px] items-end opacity-100 p-0 left-4 top-[472px] flex">
        <div className="signIn gap-4 flex-row w-[342px] justify-between items-end opacity-100 pl-0 pr-[21px] py-4 flex">
          <div className="content gap-4 flex-row w-[200.5px] items-end opacity-100 p-0 flex">
            ...
            <div className="dropdown gap-0 flex-row items-center opacity-100 p-0 flex">
              <span className="profile font-['Volta_Modern_Display'] text-base font-semibold text-[#212121] text-left tracking-[0px]">Profile</span>
            </div>
          </div>
          <div className="interactiveIcons w-6 h-6 relative opacity-100 p-0">
            <div className="boundingBox absolute w-6 h-6 bg-[#d9d9d9] opacity-100 p-0 inset-[0%]" />
  ...
  {(type == "HCO" && pageType == "Default" && state == "Dropdown" && verified == "No" && loggedInSSO == "Yes") && <>
    <div className="c01NavBarMobileAuthenticated w-[375px] h-[667px] absolute overflow-hidden bg-white opacity-100 p-0 left-[76px] top-[2944px]">
      <div className="accordians gap-0 absolute flex-col items-start opacity-100 p-0 left-0 top-[88px] flex">
        <div className="content gap-5 flex-col items-start opacity-100 px-6 py-0 !hidden flex" />
        <div className="links gap-0.5 flex-col w-[375px] items-start overflow-hidden opacity-100 pt-4 pb-3 px-4 flex">
          <div className="dropdown gap-0 flex-row items-center w-full opacity-100 p-0 flex">
  ...
  {(type == "Default" && pageType == "Default" && state == "Dropdown" && verified == "Yes" && loggedInSSO == "No") && <>
    <div className="c01NavBarMobileAuthenticated w-[375px] h-[667px] absolute overflow-hidden bg-white opacity-100 p-0 left-[76px] top-[3758px]">
      <div className="imaging w-[343px] h-[88px] absolute p-0">
        <div className="links gap-[-1px] flex-col w-[343px] items-start opacity-100 p-0 flex">
          <div className="singleNavLink gap-3 flex-col w-[342px] items-start opacity-100 p-0 flex">
            <div className="frame482707 gap-0 flex-col items-start w-full opacity-100 p-0 flex">
              <div className="frame482762 gap-3 flex-row items-start opacity-100 p-0 flex">
                ...
                <span className="prostateCancer font-['Volta_Modern_Display'] text-base font-semibold text-[#0460a9] text-left tracking-[0px]">Connect your RLT Care Account</span>
              </div>
            </div>
            <div className="1pxDivider w-full h-px relative overflow-hidden bg-[#0460a9] opacity-100 p-0" />
          </div>
          <div className="hover w-0 h-0 absolute opacity-100 p-0 left-[84665px] top-[19716px]">
            <div className="rectangle4536 absolute bottom-[-Infinity%] right-[-Infinity%] w-[6.686806624889814e+32px] h-[1.608660140006239e+32px] bg-white opacity-100 p-0 left-[Infinity%] top-[Infinity%]" />
            <div className="rectangle4533 absolute bottom-[-Infinity%] right-[-Infinity%] w-[1.1766484673715743e+32px] h-[1.4650296943732018e+32px] bg-white opacity-100 p-0 left-[Infinity%] top-[Infinity%]" />
            <div className="rectangle4534 absolute bottom-[-Infinity%] right-[-Infinity%] w-[7.748659751849668e+32px] h-[1.4650296943732018e+32px] bg-white opacity-100 p-0 left-[Infinity%] top-[Infinity%]" />
            <div className="rectangle4535 absolute bottom-[-Infinity%] right-[-Infinity%] w-[7.31817848258857e+32px] h-[1.4650293075169395e+32px] bg-white opacity-100 p-0 left-[Infinity%] top-[Infinity%]" />
            <div className="rectangle4537 absolute bottom-[-Infinity%] right-[-Infinity%] w-[4.792689504368497e+32px] h-[6.0324740743124125e+31px] bg-white opacity-100 p-0 left-[Infinity%] top-[Infinity%]" />
            <div className="rectangle4538 absolute bottom-[-Infinity%] right-[-Infinity%] w-[4.1900161916304744e+32px] h-[1.06286514294197e+32px] bg-white opacity-100 p-0 left-[Infinity%] top-[Infinity%]" />
            <div className="rectangle4539 absolute bottom-[-Infinity%] right-[-Infinity%] w-[1.4923343962209523e+32px] h-[4.8834320566731645e+32px] bg-white opacity-100 p-0 left-[Infinity%] top-[Infinity%]" />
            <div className="rectangle4540 absolute bottom-[-Infinity%] right-[-Infinity%] w-[3.3577521980690114e+32px] h-[2.125729318743284e+32px] bg-white opacity-100 p-0 left-[Infinity%] top-[Infinity%]" />
            <div className="rectangle4541 absolute bottom-[-Infinity%] right-[-Infinity%] w-[2.0089113003642504e+32px] h-[1.4937557061285568e+32px] bg-white opacity-100 p-0 left-[Infinity%] top-[Infinity%]" />
            <img src="/images/image202.png" onerror="this.src='http://svgur.com/i/x4x.svg'" className="image202 absolute bottom-[-Infinity%] h-[9.824316136857039e+32px] right-[-Infinity%] w-[9.183597058149154e+32px] opacity-100 object-cover p-0 left-[NaN%] top-[NaN%]" />
          </div>
          <div className="singleNavLink gap-3 flex-col w-[342px] items-start opacity-100 p-0 flex">
            <div className="1pxDivider w-full h-px relative overflow-hidden bg-[#bdbdbd] opacity-100 p-0" />
            <div className="frame482707 gap-0 flex-col items-start w-full opacity-100 p-0 flex">
              <div className="frame482762 gap-3 flex-row items-start opacity-100 p-0 flex">
                ...
                <span className="prostateCancer font-['Volta_Modern_Display'] text-base font-semibold text-[#212121] text-left tracking-[0px]">Signout</span>
              </div>
            </div>
            <div className="1pxDivider w-full h-px relative overflow-hidden bg-[#bdbdbd] opacity-100 p-0" />
          </div>
      ...
      <div className="title w-[375px] h-[49px] absolute p-0">
        <div className="1pxDivider w-[375px] h-px relative overflow-hidden bg-[#bdbdbd] opacity-100 p-0" />
        <div className="title w-[343px] h-[34px] relative p-0">
          <span className="title font-['Volta_Modern_Display'] text-[21px] font-medium text-[#212121] text-left tracking-[0px] w-[269px]">Sign in</span>
